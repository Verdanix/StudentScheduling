# Contributing to StudentScheduling: Guidelines for Developers, Tinkerers, and End Users

Welcome to StudentScheduling's open-source community!
I'm excited to have you on board as we work together to create secure,
efficiency, and privacy focused scheduling software for student-run stores.

## Getting Started
Before diving into the contributing guidelines, please take a moment to familiarize yourself with my project:
- Visit the [README.md](./README.md) for an overview of StudentScheduling features and capabilities.
